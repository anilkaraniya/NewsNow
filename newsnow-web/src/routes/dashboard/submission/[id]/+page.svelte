<script lang="ts">
  ...
  async function handlePublish() {
    if (
      !confirm(
        "Are you sure you want to publish this article? This will make it visible to all users."
      )
    ) {
      return;
    }
    ...
    try {
      ...
      // Refresh the article to get the latest data
      article = await getArticle(articleId);
...
<div class="edit-container">
  <div class="page-header">
    <div class="header-content">
      <a href="/dashboard/submission" class="back-button">← Back to Articles</a>
      <h1>Edit Article</h1>
    </div>
  ...
  {:else if !article}
    <div class="not-found">
      ...
      <a href="/dashboard/submission" class="back-link">Back to Articles</a>
    </div>
  {:else}
